...
\begin{gather*}
\intf{a}{b}{f(x)}\approx \intf{a}{b}{\varphi(x)}
\end{gather*}
...
%\sum\limits_{i=0}^{n}\;\int\limits_{x_{i-1}}^{x_i}f(x)dx
\intf{a}{b}{f(x)}=
\sum\limits_{i=0}^{n}\;\intf{x_{i-1}}{x_i}{f(x)}
\end{gather*}
...
\begin{gather*}
S^{-}_i\approx\intf{x_{i-1}}{x_i}{L_0(x)}=
...
\begin{gather*}
S_i\approx\intf{x_{i-1}}{x_i}{L_1(x)}=
...
\begin{gather*}
S_i\approx\intf{x_{i-1}}{x_{i+1}}{L_2(x)}=
...
\begin{gather*}
I_1=\intf{x_0}{x_1}{L_2(x)}=
\intf{-3.31}{1.32}{\left(5.66-4.74\cdot x-1.73\cdot x^2\right)}=25.88
\end{gather*}
...
\begin{gather*}
I_2=\intf{x_1}{x_2}{L_2(x)}=
\intf{1.32}{3.50}{\left(-25.56+21.76\cdot x-3.87\cdot x^2\right)}=6.13
\end{gather*}
