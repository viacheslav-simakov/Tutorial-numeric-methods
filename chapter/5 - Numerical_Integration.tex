...
% f(x)
\addplot[name path=A,PlotDarkBlue,mark=none,
...
\begin{tikzpicture}[baseline]
\begin{axis}
\addplot[name path=A,const plot mark left,
...
\begin{tikzpicture}[baseline]
\begin{axis}
\addplot[name path=A,const plot mark right,
thick,draw=darkblue,mark=ball,mark size=3pt,
mark options={ball color=darkblue!50,thin,draw=darkblue}
] coordinates 
{(-3.31,2.45) (0.31,4.03) (1.32,-3.61) (2.47,4.50) (3.50, 3.1)};
...
\begin{gather*}
L^{(2)}_2(x)=-25.56+21.76\cdot x-3.87\cdot x^2
\end{gather*}
