...
\node[datanode,on chain,join]{%
$\vect{a}, \vect{b}, \vect{c}, \vect{y}$};%\allowbreak
...
$\vect{\alpha}=(\alpha_1,\alpha_2,\ldots,\alpha_n)$ и
$\vect{\beta}=(\beta_1,\beta_2,\ldots,\beta_n)$}
...
% входные данные
\node[datanode,on chain,join]{%
$\vect{\alpha}, \vect{\beta}, \vect{y}$};%\allowbreak
% u[n]
\node[rectnode,on chain,join]{$
u_n=\dfrac{a_n\cdot\beta_n+y_n}{c_n-a_n\cdot\alpha_n}
$};
...
значений неизвестной функции $\vect{u}=(u_0,u_1,\ldots,u_n)$
