...
%\end{array}\right.
\begin{cases}
u(x_i)=\const,&x_{i-1/2} \leqslant x \leqslant x_{i+1/2}\\
w(x_{i+1/2})=\const,&x_i \leqslant x \leqslant x_{i+1}\\
k(x_i), r(x_i), q(x_i)=\const,&x_{i-1/2} \leqslant x \leqslant x_{i+1/2}
\end{cases}.
\end{gather}
