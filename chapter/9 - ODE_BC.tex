...
$\alpha_1$ и $\beta_1$, которые определяются из краевого условия
на левой границе рассматриваемой области $x=0$:
\begin{gather*}
\begin{cases}
c_0\cdot u_0-b_0\cdot u_1 = y_0\\
...
\begin{gather}\label{eq:ODE+BC:ALPHA1+BETA1}
...
\eqref{eq:ODE+BC:ALPHA+BETA} и \eqref{eq:ODE+BC:ALPHA1+BETA1}
...
\begin{gather}\label{eq:ODE+BC:u(n)}
\begin{cases}
-a_n\cdot u_{n-1}+c_n\cdot u_n = y_n\\
