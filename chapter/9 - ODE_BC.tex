...
\item
Упорядочиваются все точки разрыва $\xi_j$ ($j=1,2,\ldots,m$)
коэффициентов краевой задачи:
\begin{equation*}
\xi_1<\xi_2<\ldots<\xi_m,
\end{equation*}
где $m$ -- количество точек разрыва коэффициентов краевой задачи.

\item
Определяются области непрерывности 
\emph{всех коэффициентов} краевой задачи в расчётной области:
\begin{equation*}
[0,\xi_1)\cup[\xi_1,\xi_2)\cup\ldots\cup[\xi_{m-1},\xi_m]=[0,\ell]
\end{equation*}
\end{enumerate}
