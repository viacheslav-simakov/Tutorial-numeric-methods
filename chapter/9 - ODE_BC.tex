...
такова, что эта система распадается на две независимые системы 
для неизвестных $\{w_{1/2},w_{3/2},\ldots,w_{n-1/2}\}$ и
$\{u_0,u_1,\ldots,u_n\}$. 

Построим независимую систему для неизвестных $u_i$ ($i=0,1,\ldots,n$).
...
\end{cases}
\end{equation*}
или группируя слагаемые при неизвестных  
$u_{i-1}$, $u_i$, $u_{i+1}$:
...
\end{cases}
\end{equation}
где $a_i$, $b_i$ и $c_i$ -- коэффициенты матрицы:
\begin{equation*}
\begin{cases}
b_0=\sigma(x_0),\;
...
то соответствующую разностную схему можно решить 
...
с трехдиагональной матрицей $\mathbf{M}$, т.е. с матрицей, 
все элементы которой, не лежащие на главной и 
двух побочных диагоналях, равны нулю.
...
Решение системы линейных уравнений \eqref{eq:ODE+BC:SLE(u)}
будем искать в виде:
...
Соотношения \eqref{eq:ODE+BC:ALPHA+BETA} представляют собой 
