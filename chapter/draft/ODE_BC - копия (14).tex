...
\caption{Виды краевых задач для дифференциальных уравнений второго порядка}
...
\begin{figure} % *** Задача Дирихле и Неймана ****
\begin{center}
...
\begin{gather*}
Q = \mathring{r}\cdot\brackets{\mathring{u} - u}
,\end{gather*}
...
(b) -- локальный нагрев боковой поверхности стержня}
...
$[0,c]$ и $(c,\ell]$ -- участки стержня, соостоящие из разных материалов
...
Расстояние между соседними узлами рассчетной сетки $h_i$ (шаг сетки), 
...
и тепловыделения (теплопоглащения) для контрольной области
