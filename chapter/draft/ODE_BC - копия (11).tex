...
\begin{comment}
текающего через сечение х = **+уа тепла; третье слагаемое в левой части (20) дает количество тепла, выделяющегося на отрезке [я*_»/з> лсг+у2] за счет распределенных с плотностью }(х) источников тепла, интеграл в правой части (20) есть количество тепла, отдаваемое внешней среде за счет теплообмена на боковой поверхности.
\end{comment}
