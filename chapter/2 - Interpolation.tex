...
на отрезке $x\in[a, b]$ заменяется интерполяционным полиномом 
$f(x)\approx p_n(x)$, который построен как линейная комбинация 
$n$ аналитических функций $\{\phi_i(x)\}$
\begin{gather}
...
\;\iff\;
\begin{pmatrix}[cccc|c]
1&-0.76&\fcolorbox{gray}{yellow}{2.138}&0.468&0.08\\
