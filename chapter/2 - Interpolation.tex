...
L_{n}(x)
=c_{0}(x)\cdot{y_0}+c_{1}(x)\cdot{y_1}+\dots+c_{n}(x)\cdot{y_n}
=\sum\limits_{i=0}^n c_i(x)\cdot y_i
\end{equation}
где $c_0(x),c_1(x),\dots,c_n(x)$ -- произвольные неизвестные функции.

Из условий интерполирования:
\begin{equation*}\label{inter2}
\left\{\begin{matrix}
c_0(x_0)\cdot{y_0}+c_1(x_0)\cdot{y_1}+\dots+c_n(x_0)\cdot{y_n}&=&y_0\\
c_0(x_1)\cdot{y_0}+c_1(x_1)\cdot{y_1}+\dots+c_n(x_1)\cdot{y_n}&=&y_1\\
\hdotsfor{3}\\
c_0(x_n)\cdot{y_0}+c_1(x_n)\cdot{y_1}+\dots+c_n(x_n)\cdot{y_n}&=&y_n\\
\end{matrix}\right.
\end{equation*}

Система уравнений имеет решение если выполняются условия:
\begin{equation*}
\label{uslovia_c}
