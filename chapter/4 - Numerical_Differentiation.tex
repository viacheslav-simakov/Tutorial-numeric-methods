...
\end{figure}
% *******************************
Определим первую и вторую производную функции 
$y(x)$ в точке $x_1=-0.98$:
\begin{gather*}
...
% x2
\item
Апроксимацию функции $y(x)$ в узлах $\{x_{1},x_{2},x_{3}\}$
полиномом Лагранжа второго порядка $L_2(x)$, 
используя данные таблицы \ref{tab:Num_Diff}:
\begin{gather*}
\begin{matrix}
...
\end{figure}
% *******************************
Определим первую и вторую производную функции $y(x)$ в точке $x_2=-0.76$:
\begin{gather*}
...
% x3
\item
Апроксимацию функции $y(x)$ в узлах $\{x_{2},x_{3},x_{4}\}$
полиномом Лагранжа второго порядка $L_2(x)$, 
используя данные таблицы \ref{tab:Num_Diff}:
\begin{gather*}
\begin{matrix}
...
\end{figure}
% *******************************
Определим первую и вторую производную функции $y(x)$ в точке $x_3=-0.48$:
\begin{gather*}
