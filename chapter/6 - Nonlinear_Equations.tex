...
$x_1$, $x_2$ и $x_3$ -- действительные корни уравнения $f(x)=0$,
т.е. $f(x_1)=0, f(x_2)=0, f(x_3)=0,$
...
\addplot[thick,color=black,domain=-1.5:2.75, samples=2] {0};
\addplot[thick,color=red,domain=-1.25:2.5, samples=100] {(x-1)*(x+1)*(x-2)};
