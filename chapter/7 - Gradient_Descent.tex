...
% начальная точка
\addplot[only marks,ball darkblue]
coordinates {(-3,-10)} node[below]{$(x_0,y_0)$};
\addplot[darkblue]
coordinates {
(-3.000,-10.000) (0.552,-10.000) (0.552,-1.998)
(0.552,-1.998) (-0.498,-1.998) (-0.498,-2.000)
(-0.498,-2.000) (-0.500,-2.000)
};
\end{axis}
\end{tikzpicture}
\end{subfigure}
