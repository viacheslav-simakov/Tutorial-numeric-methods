...
\addplot[black!90] plot table [x={X0},y={Y0}]{chapter/counter1.txt}
node[pos=0.25,xshift=+7pt]{\tiny$10$};
\addplot[black!50] plot table [x={X1},y={Y1}]{chapter/counter2.txt}
node[pos=0.25,xshift=+7pt]{\tiny$12$};
\addplot[black!35] plot table [x={X2},y={Y2}]{chapter/counter3.txt}
node[pos=0.25,xshift=+7pt]{\tiny$15$};
\addplot[black!20] plot table [x={X3},y={Y3}]{chapter/counter4.txt}
node[pos=0.25,xshift=+7pt]{\tiny$18$};
% начальная точка
\addplot[only marks,ball darkred]
coordinates {(-3,-8)} node[below]{$(x_0,y_0)$};
\addplot[->,darkred]
coordinates {(-3.000,-8.000) (0.747,-8.000) (0.747,-2.006) (-0.496,-2.006)};
% конечная точка
\addplot[only marks,ball darkred]
coordinates {(-0.5,-2.0)};% node[left]{$(x_{\min},y_{\min})$};
\end{axis}
\end{tikzpicture}
\end{subfigure}
\caption{График и ``рельеф`` функции двух переменных
\scalebox{0.85}{$f(x,y)=
\sqrt{	(x-0.35)^2	+ (y-1.5)^2	} +
\sqrt{	(x+0.5)^2	+ (y+2)^2	} +
\sqrt{	(x-1)^2		+ (y+7)^2	}$}
