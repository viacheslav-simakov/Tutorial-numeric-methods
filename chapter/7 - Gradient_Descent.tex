...
plot table [x={latitude},y={longitude}]{chapter/counter1.txt}
node[pos=0.65,fill=white,yshift=+7pt]{\tiny$850$};
\addplot[black!50,smooth]
plot table [x={latitude},y={longitude}]{chapter/counter2.txt}
node[pos=0.6,fill=white]{\tiny$900$};
\addplot[black!35,smooth]
plot table [x={latitude},y={longitude}]{chapter/counter3.txt}
node[pos=0.6,fill=white]{\tiny$1000$};
\addplot[black!20,smooth]
plot table [x={latitude},y={longitude}]{chapter/counter4.txt}
node[pos=0.6,fill=white]{\tiny$1100$};
% начальная точка
