...
% целевая функция
\addplot3[surf,opacity=0.5,thin,samples=20,
domain=-6:6,y domain=-10:4]{myfunc(x,y)};
% начальная точка
\addplot3[only marks,ball darkred]
coordinates {({-3},{-8},{myfunc(-3,-8)})}
node[below]{$(x_0,y_0)$};
\addplot3[<-,darkred]
coordinates{
(-3.000,-8.000,{myfunc(-3,-8)})
(0.747,-8.000,{myfunc(0.747,-8)})
(0.747,-2.006,{myfunc(0.747,-2.006)})
(-0.496,-2.006,{myfunc(-0.496,-2.006)})
};
% конечная точка
\addplot3[only marks,ball darkred]
coordinates{(-0.5,-2.0,{myfunc(-0.5,-2.0)})};
\end{axis}
\end{tikzpicture}
\end{subfigure}% ВАЖНО!
%
