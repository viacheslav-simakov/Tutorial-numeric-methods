...
\addplot[black!90] plot table [x={X},y={Y}]{chapter/counter1.txt};
%\addplot[black!50] plot table [x={X},y={Y}]{chapter/counter2.txt};
%\addplot[black!35] plot table [x={X},y={Y}]{chapter/counter3.txt};
%\addplot[black!20] plot table [x={X},y={Y}]{chapter/counter4.txt};
% начальная точка
\addplot[darkblue]
coordinates {
(-4,-8) (0.747,-8.000) (0.747,-2.006)
(0.747,-2.006) (-0.496,-2.006) (-0.496,-2.000)
(-0.496,-2.000) (-0.500,-2.000) (-0.500,-2.000)
};
%node[below]{$(x_0,y_0)$};
\end{axis}
\end{tikzpicture}
