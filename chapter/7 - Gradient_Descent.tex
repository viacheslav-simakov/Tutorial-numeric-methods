...
\phi_{\inf}&=&\min(\phi_1,\phi_2,\phi_3) = \phi_2&=&51.534\\
\phi_{\sup}&=&\max(\phi_1,\phi_2,\phi_3) = \phi_3&=&56.671\\
\end{matrix}\right.
\\
\left\{\begin{matrix}[lclcl]
\lambda_{\inf}&=&\min(\lambda_1,\lambda_2,\lambda_3)=\lambda_1&=&37.630\\
\lambda_{\sup}&=&\max(\lambda_1,\lambda_2,\lambda_3)=\lambda_2&=&46.031\\
\end{matrix}\right.
\end{gather*}
...
\end{matrix}\right.
\quad\to\quad
\mathcal{D}=\left\{\begin{matrix}[rcl]
