...
% ЗАГЛАВИЕ
\emptyline
\textbf{МЕТОДЫ ЧИСЛЕННОГО АНАЛИЗА В ФИЗИКЕ}\\
\emptyline
Учебное пособие
\emptyline
...
В пособии изложен материал, необходимый студентам для 
приобретения навыков применения численных методов 
при решении задач теоретического и прикладного характера 
в области материаловедения и технологии материалов. 
Представлены основы численных методов решения задач алгебры, 
математического анализа, оптимизации, обыкновенных 
дифференциальных уравнений. 
Рассмотрены алгоритмы и возможности их применения для 
приближенного решения различных классов прикладных задач.
