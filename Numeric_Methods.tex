...
% ЗАГЛАВИЕ
\emptyline
<<\textbf{МЕТОДЫ ЧИСЛЕННОГО АНАЛИЗА В МАТЕРИАЛОВЕДЕНИЕ}>>\\
\emptyline
для студентов 2 курса\\
направление подготовки бакалавриата\\
22.03.01 <<Материаловедение и технологии материалов>>,\\
профиль подготовки
<<Нанотехнологии, диагностика и синтез современных материалов>>,\\
института физики
\par
...
появилась в связи с необходимостью решения новых 
комплексных задач, возникающих в ходе развития современной 
физики, материаловедения и новейших областей техники и технологий. 
Использование ЭВМ при решение научных и технических задач 
позволяет провести детальное математическое моделирование 
процессов и систем (вычислительному эксперименту), 
которое существенно сокращает потребность 
в натурных экспериментах, а в ряде случаев может их заменить. 

Использование численных методов допускает применения 
простых алгоритмов вычислений, которые гарантируют
нахождение приближенного решения поставленной задачи
за конечное число математических операций.
Однако, для численных методов характерна множественность, 
т.е. возможность решить одну и ту же задачу различными методами. 

В пособии излагаются основы численных методов решения задач
алгебры, анализа, оптимизации, обыкновенных дифференциальных 
уравнений. Представлены методики построения и  
применения алгоритмов приближенного решения различных 
классов математических задач, изложен минимальный материал, 
необходимый студентам для приобретения навыков 
применения численных методов при решении 
...
Материал изложен четко и сжато, при этом большое внимание 
уделено рекомендациям по практическому применению алгоритмов;
изложение иллюстрировано рядом примеров применения численных
...
владеют навыками решения задач с помощью ЭВМ.
